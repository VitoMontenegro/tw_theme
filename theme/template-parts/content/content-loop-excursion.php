...
if (isset($category_id)) {
	...
	if ($query->have_posts()) {
		...
		if ($query->found_posts > $query->current_post + 1) {
			echo '<button class="col-span-12 pt-1 load-more" data-page="2"><span class="inline-block font-bold text-[#ff7642] py-2  px-4 sm:px-8 border-2 border-[#ff7642] rounded-3xl hover:text-white hover:bg-[#FF7643]">Загрузить ещё</span></button>';
		}
	} else {
