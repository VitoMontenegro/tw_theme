...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div id="posts-container" class="container">
		<div class="grid grid-cols-12 lg:grid-cols-15 p-4 sm:p-8 rounded-2xl bg-white">
			...
			<div class="lg:col-span-7 col-span-12 lg:ps-10 mt-1 sm:mt-4 lg:mt-0">
				...
				<header class="entry-header">
					<h1 class="mt-2 mb-1 sm:mb-3 text-[15px] sm:text-[30px] font-bold sm:leading-9 tracking-[0.1px]"><?php the_title(); ?></h1>
				</header>

				<div class="flex flex-col sm:flex-row md:items-center mb-1 sm:mb-2 md:mb-3 lg:mb-[18px] gap-1 sm:gap-4 lg:gap-3">
				...
				<div class="block sm:flex gap-3">
					<a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo preg_replace('/[^0-9]/', '', $options['watsapp']);  ?>&text=Здравствуйте.+Я+обращаюсь+с+сайта+flagmanspb.ru" class="inline-flex text-white px-8 lg:px-9 py-2.5 sm:py-2 lg:py-2.5] rounded-full justify-center items-center gap-2 mb-3  bg-[#30d26e] hover:bg-[#1ABF59]">
		...
		<div class="flex gap-6">
			<div class="w-[265px] min-w-[265px] hidden lg:block">
			...
			<div class="entry-content overflow-x-hidden">
				...
				<div class="entry-content">
					<div class="bg-white pt-6 sm:pt-4 lg:pt-7 px-5 sm:px-8 md:pb-5 sm:pb-8 rounded-3xl big-title" id="sectionDesc">
						<?php the_content(); ?>
					</div>
					...
					<div class="bg-white pt-6 sm:pt-4 lg:pt-7 sm:pb-5 sm:pb-8 px-5 sm:px-8 pb-[220px] rounded-3xl mt-5 sm:mt-6l bg-end bg-no-repeat" id="sectionCost">
						<?php if(!empty($fields['table_price'])): ?>
							...
							<table class="inline-table	 sm:hidden min-w-full border-collapse text-[11px] mb-4 w-full">
								<?php if (!empty($fields['table_price'])): ?>
									<thead>
									<tr class="bg-[#CFC5FF]">
					...
					<div class="rounded-3xl flex-col sm:flex-row mt-5" id="sectionBuses" >
						...
						<div class="sub_slide mt-4 relative">
							<div class="flex gap-4 overflow-x-auto overflow-y-hidden sm:overflow-hidden">
								...
								<div class="min-w-[266px] md:min-w-0   sm:w-1/3 bg-[#3A21AA] rounded-2xl h-[200px] flex justify-center items-center px-6">
