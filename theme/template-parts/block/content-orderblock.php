...
?>
<div class="flex mb-10 gap-4 mt-8 sm:mt-10 flex-col sm:flex-row">
	...
	<div class="w-wull sm:w-7/12 bg-white rounded-2xl p-8">
		...
		<a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo preg_replace('/[^0-9]/', '', $options['watsapp']);  ?>&text=Здравствуйте.+Я+обращаюсь+с+сайта+flagmanspb.ru" class="px-8 py-3 bg-[#30D26E] hover:bg-[#30D26E] rounded-full justify-center items-center inline-flex mb-6">
		...
		<a target="_blank" href="tg://resolve?domain=<?php echo $options['telegram'];  ?>" class="px-8 py-3 bg-[#69C5FD] hover:bg-[#69C5FD] rounded-full justify-center items-center inline-flex mb-6">
			<span class="flex gap-2 items-center">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
