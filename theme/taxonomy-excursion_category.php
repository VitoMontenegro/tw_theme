						...
						<div class="entry-content mt-11">
							...
							<div class="rounded-3xl mt-5 sm:mt-8 flex flex-col gap-4 sm:flex-row sm:mb-[64px]" id="sendMe">
								...
								<div class="w-full bg-white rounded-2xl px-6 lg:px-8 py-5 lg:py-7">
									...
									<a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo preg_replace('/[^0-9]/', '', $options['watsapp']);  ?>&text=Здравствуйте.+Я+обращаюсь+с+сайта+flagmanspb.ru" class="w-3/5 sm:w-auto sm:px-8 py-2.5 bg-[#30D26E] hover:bg-[#1ABF59] rounded-full justify-center items-center inline-flex mb-3 sm:mb-6">
										<span class="flex gap-2 items-center">
											<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
									...
									<a target="_blank" href="tg://resolve?domain=<?php echo $options['telegram'];  ?>" class="w-3/5 sm:w-auto sm:px-8 py-2.5 bg-[#69C5FD] hover:bg-[#4ea8de] rounded-full justify-center items-center inline-flex mb-6">
										<span class="flex gap-2 items-center">
											<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
