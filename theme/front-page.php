	...
	<section class="hero container mx-auto mt-[13px] px-4">
		<div class="flex gap-3 flex-col lg:flex-row">
					...
					<div class="flex gap-3 px-[18px] overflow-x-auto">
						<div class="w-[266px] min-w-[266px] md:min-w-0 lg:w-1/3 bg-[#8fa9ff] rounded-2xl h-[108px] flex justify-center items-center px-4 tracking-[-0.2px] leading-[18px]">
							<div class="flex gap-2 items-center justify-start w-full">
								...
								<div class="font-bold">Собственный автопарк <br>
									и новые автобусы <br>
									2024 г.</div>
							</div>
						</div>
						...
						<div class="w-[266px] min-w-[266px] md:min-w-0 lg:w-1/3 bg-[#FDC401] rounded-2xl h-[108px] flex justify-center items-center px-4">
							<div class="flex gap-2 items-center justify-start w-full">
								...
								<div class="font-bold">Более 50 увлекательных обучающих программ для детей</div>
							</div>
						</div>
			...
			<div class="clouds relative lg:w-[240px] sm:min-w-[240px] h-[146px] lg:h-[323px] bg-[#ff7642] rounded-2xl py-6 px-4  bg-center bg-contain bg-no-repeat" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/images/clouds.webp')">
				...
				<svg class="lg:hidden absolute bottom-0 right-6" xmlns="http://www.w3.org/2000/svg" width="126" height="60" viewBox="0 0 126 60" fill="none">
					<path d="M125 6.72224L91.11 15.3466L90.2039 15.5725L90.1223 15.4447L86.3618 20.3305L87.3344 10.1369L83 4L125 6.72224Z" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M124.999 6.72217L98.0474 28.3872L91.9701 18.4611L90.2031 15.5724L91.1093 15.3466L124.999 6.72217Z" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M124.999 6.72217L91.1088 15.3466L90.1211 15.4446L124.999 6.72217Z" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M87.3359 10.1369L125.001 6.72217L90.1268 15.4446L86.3633 20.3304L87.3359 10.1369Z" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M86.3633 20.3304L92.2835 18.9692" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M83 24.5265C71.62 28.6469 58.9084 29.2243 47.1812 26.1525C42.1688 24.8406 37.1422 22.7435 33.8228 18.8679C30.5035 14.9924 29.3907 8.99198 32.3867 4.87622C35.8677 0.0906792 43.7905 -0.16338 48.4462 3.55974C53.1018 7.28285 54.6236 13.8237 53.4395 19.5654C52.2506 25.3072 48.76 30.356 44.8082 34.7813C33.5755 47.3549 17.7966 55.7896 1 59" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="6 6"/>
				</svg>
